...
void loop() {
  ...
  read_mpu_6050_data();
  Serial.print("EIXO X: ");
  Serial.print(convertRawToMs2(acc_x,4096)); 
  Serial.print(" EIXO Y: ");
  Serial.print(convertRawToMs2(acc_y,4096)); 
  Serial.print(" EIXO Z: ");
  Serial.println(convertRawToMs2(acc_z,4096)); 
}
...
float convertRawToMs2(int16_t raw, int16_t typical ){
  float rawConvertedToMs2;
  rawConvertedToMs2 = ((float)raw/typical)* 9.80665;
  return rawConvertedToMs2;
}
