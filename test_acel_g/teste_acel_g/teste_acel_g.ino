...
void loop() {
  ...
  read_mpu_6050_data();
  Serial.print("EIXO X: ");
  Serial.print(convertRawToG(acc_x,4096)); 
  Serial.print(" EIXO Y: ");
  Serial.print(convertRawToG(acc_y,4096)); 
  Serial.print(" EIXO Z: ");
  Serial.println(convertRawToG(acc_z,4096)); 
}
...
float convertRawToG(int16_t raw, int16_t typical ){
  float rawConvertedToG;
  rawConvertedToG = (float)raw/typical;
  return rawConvertedToG;
}
